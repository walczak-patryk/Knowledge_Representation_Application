...
namespace KR_Lib.Structures
{
    ...
    {
        public InconsistentStructure(int endTime, List<ActionOccurrence> acs, List<ActionWithTimes> actions, List<(int, List<Fluent>)> timeFluents1) : base(endTime, acs, actions, timeFluents1)
        {
