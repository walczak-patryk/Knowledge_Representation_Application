...
namespace KR_Lib.Structures
{
    ...
    {
        public InconsistentStructure(int endTime, List<ActionOccurrences> acs, List<(Action, int, int)> actions, List<(int, List<Fluent>)> timeFluents1) : base(endTime, acs, actions, timeFluents1)
        {
